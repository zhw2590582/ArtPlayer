  ...
  */
  ...
  function version(option) {
    return _objectSpread$3(_objectSpread$3({}, option), {}, {
      html: '<a href="https://artplayer.org" target="_blank">ArtPlayer 4.3.5</a>'
    });
  }
  ...
  console.log('%c ArtPlayer %c 4.3.5 %c https://artplayer.org', 'color: #fff; background: #5f5f5f', 'color: #fff; background: #4bc729', '');
