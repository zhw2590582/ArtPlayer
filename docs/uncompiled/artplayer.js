  ...
  */
  ...
  function version(option) {
    return _objectSpread$6(_objectSpread$6({}, option), {}, {
      html: '<a href="https://artplayer.org" target="_blank">ArtPlayer 4.0.2</a>'
    });
  }
  ...
  console.log('%c ArtPlayer %c 4.0.2 %c https://artplayer.org', 'color: #fff; background: #5f5f5f', 'color: #fff; background: #4bc729', '');
