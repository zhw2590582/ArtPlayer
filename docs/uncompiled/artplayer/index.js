        ...
        set (ratio) {
            ...
            if (ratio === "default") {
                ...
                if (playerRatio > setupRatio) {
                    const width = (0, _utils.clamp)(setupRatio * clientHeight, 0, clientWidth);
                    (0, _utils.setStyle)($video, "width", `${width}px`);
                    (0, _utils.setStyle)($video, "height", "100%");
                    (0, _utils.setStyle)($video, "padding", `0 ${(clientWidth - width) / 2}px`);
                } else {
                    const height = (0, _utils.clamp)(clientWidth / setupRatio, 0, clientHeight);
                    (0, _utils.setStyle)($video, "width", "100%");
                    (0, _utils.setStyle)($video, "height", `${height}px`);
                    (0, _utils.setStyle)($video, "padding", `${(clientHeight - height) / 2}px 0`);
                }
