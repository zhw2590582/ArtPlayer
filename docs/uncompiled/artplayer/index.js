...
function tooltip(target, msg, pos = 'up') {
...
},{"../utils":"jmgNb","./zh-cn.json":"cVMb8","./zh-tw.json":"fS55m","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"cVMb8":[function(require,module,exports) {
...
},{"screenfull":"egkJg","../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"egkJg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"chbtA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utils = require("../utils");
...
function fullscreen(option) {
    return (art)=>({
            ...
            mounted: ($control)=>{
                ...
                _utils.append($control, icons.fullscreen);
                proxy($control, 'click', ()=>{
                    art.fullscreen = !art.fullscreen;
                });
                art.on('fullscreen', (value)=>{
                    _utils.tooltip($control, i18n.get(value ? 'Exit Fullscreen' : 'Fullscreen'));
                });
            }
        })
    ;
...
function fullscreenWeb(option) {
    return (art)=>({
            ...
            mounted: ($control)=>{
                const { events: { proxy  } , icons , i18n ,  } = art;
                _utils.append($control, icons.fullscreenWeb);
                proxy($control, 'click', ()=>{
                    art.fullscreenWeb = !art.fullscreenWeb;
                });
                art.on('fullscreenWeb', (value)=>{
                    _utils.tooltip($control, i18n.get(value ? 'Exit Web Fullscreen' : 'Web Fullscreen'));
                });
            }
        })
    ;
...
},{"../utils":"jmgNb","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"lNXYh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utils = require("../utils");
...
class Notice {
    ...
    set show(msg) {
        ...
        if (!msg) return _utils.removeClass($player, 'art-notice-show');
...
var _fullscreenSvg = require("bundle-text:./fullscreen.svg");
var _fullscreenSvgDefault = parcelHelpers.interopDefault(_fullscreenSvg);
var _fullscreenWebSvg = require("bundle-text:./fullscreen-web.svg");
var _fullscreenWebSvgDefault = parcelHelpers.interopDefault(_fullscreenWebSvg);
...
class Icons {
    constructor(art){
        const icons = {
            ...
            fullscreen: _fullscreenSvgDefault.default,
            fullscreenWeb: _fullscreenWebSvgDefault.default,
...
},{"../utils":"jmgNb","bundle-text:./loading.svg":"kQAWs","bundle-text:./state.svg":"fv62Y","bundle-text:./check.svg":"hpwmG","bundle-text:./play.svg":"ez3XI","bundle-text:./pause.svg":"cXb2s","bundle-text:./volume.svg":"9ziFm","bundle-text:./volume-close.svg":"gHdy5","bundle-text:./subtitle.svg":"iYRIe","bundle-text:./screenshot.svg":"7uQ3x","bundle-text:./setting.svg":"23jGe","bundle-text:./fullscreen.svg":"dLrgt","bundle-text:./fullscreen-web.svg":"auPzM","bundle-text:./arrow-left.svg":"2m0J3","bundle-text:./arrow-right.svg":"d9iPY","bundle-text:./playback-rate.svg":"iFVXO","bundle-text:./aspect-ratio.svg":"4qJAN","bundle-text:./config.svg":"6iK2N","bundle-text:./pip.svg":"f0XBL","bundle-text:./lock.svg":"kCaVg","bundle-text:./unlock.svg":"lWIPo","@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6"}],"kQAWs":[function(require,module,exports) {
...
},{}],"iYRIe":[function(require,module,exports) {
...
},{}],"dLrgt":[function(require,module,exports) {
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"36\" width=\"36\" viewBox=\"0 0 36 36\">\n\t<path d=\"m 10,16 2,0 0,-4 4,0 0,-2 L 10,10 l 0,6 0,0 z\"></path>\n\t<path d=\"m 20,10 0,2 4,0 0,4 2,0 L 26,10 l -6,0 0,0 z\"></path>\n\t<path d=\"m 24,24 -4,0 0,2 L 26,26 l 0,-6 -2,0 0,4 0,0 z\"></path>\n\t<path d=\"M 12,20 10,20 10,26 l 6,0 0,-2 -4,0 0,-4 0,0 z\"></path>\n</svg>";

},{}],"auPzM":[function(require,module,exports) {
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 36 36\" height=\"36\" width=\"36\">\n\t<path d=\"m 28,11 0,14 -20,0 0,-14 z m -18,2 16,0 0,10 -16,0 0,-10 z\" fill-rule=\"evenodd\"></path>\n</svg>";
...
class Setting extends _componentDefault.default {
    ...
    init(option, width) {
        if (this.cache.has(option)) {
            ...
            if (option[0] && option[0]._parentItem) _utils.append($panel, this.creatHeader(option[0]));
