    ...
    return (art)=>{
        ...
        return {
            ...
            mounted: ($control)=>{
                ...
                (0, _utils.setStyle)($played, "backgroundColor", "var(--art-theme)");
