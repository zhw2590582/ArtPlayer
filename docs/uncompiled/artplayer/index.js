            ...
            <div class="art-info">
              <div class="art-info-panel">
                <div class="art-info-item">
                  ...
                  <div class="art-info-content">${"4.4.0"}</div>
                </div>
                <div class="art-info-item">
...
function version(option) {
    return {
        ...option,
        html: `<a href="https://artplayer.org" target="_blank">ArtPlayer ${"4.4.0"}</a>`
    };
}
                ...
                case 'selector':
                    if (item.selector && item.selector.length) this.init(item.selector, item.width);
                        ...
                        if (item._parentItem && item._parentItem.onSelect) {
                            ...
                            if (item._parentItem.$tooltip && isStringOrNumber(result)) item._parentItem.$tooltip.innerHTML = result;
                        }
                    }
                    break;
                default:
