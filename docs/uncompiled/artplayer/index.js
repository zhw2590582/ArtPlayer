            ...
            mounted: ($control)=>{
                ...
                function setBar(type, percentage) {
                    ...
                    if (type === "played") {
                        ...
                        (0, _utils.setStyle)($indicator, "left", `calc(${percentage * 100}% - var(--art-indicator-size) / 2)`);
                    }
                }
...
class Mobile {
    constructor(art){
        ...
        for(const key in option.moreVideoAttr)$video[key] = option.moreVideoAttr[key];
        $video.controls = true;
