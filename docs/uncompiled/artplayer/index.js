            ...
            <div class="art-info">
              <div class="art-info-panel">
                <div class="art-info-item">
                  ...
                  <div class="art-info-content">${"4.4.3"}</div>
                </div>
                <div class="art-info-item">
...
function version(option) {
    return {
        ...option,
        html: `<a href="https://artplayer.org" target="_blank">ArtPlayer ${"4.4.3"}</a>`
    };
}
