...
artplayerPluginDanmuku.version = "4.4.3";
artplayerPluginDanmuku.build = "1653308783161";
...
function setting(art, danmuku) {
    ...
    const $danmuStyle = getIcon(_danmuStyleSvgDefault.default, 'danmu-style');
    function addEmitter() {
        const colors = [
            '#FE0302',
            '#FF7204',
        ...
        art.on('destroy', ()=>{
            if (option.mount) option.mount.removeChild($emitter);
        });
    }
    function addControl() {
        art.controls.add({
