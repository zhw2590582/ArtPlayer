...
artplayerPluginDanmuku.build = "1652685093596";
...
function setting(art, danmuku) {
    ...
    if (danmuku.option.mount instanceof Element) $control = danmuku.option.mount;
    function addEmitter() {
        const colors = [
            '#FE0302',
            '#FF7204',
        ...
        if ($control !== $controlsCenter) addClass($emitter, 'art-danmuku-mount');
