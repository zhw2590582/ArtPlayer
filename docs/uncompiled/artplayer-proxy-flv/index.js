...
})({"k0WKa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>artplayerProxyFlv);
var _wxinlinePlayer = require("./WXInlinePlayer");
var _wxinlinePlayerDefault = parcelHelpers.interopDefault(_wxinlinePlayer);
function artplayerProxyFlv(opt = {}) {
    return (art)=>{
        const { option, constructor } = art;
        const { createElement, def } = constructor.utils;
        if (!(0, _wxinlinePlayerDefault.default).isSupport()) throw new Error("WXInlinePlayer is not support");
        let player = null;
        ...
        async function init() {
            (0, _wxinlinePlayerDefault.default).init({
                asmUrl: opt.asmUrl,
                wasmUrl: opt.wasmUrl
            });
            await (0, _wxinlinePlayerDefault.default).ready();
            if (player) {
                player.destroy();
                player = null;
            }
            player = new (0, _wxinlinePlayerDefault.default)({
                url: option.url,
                $container: canvas,
                ...opt
            });
        ...
        def(canvas, "play", {
            value: async ()=>{
                ...
                if (canvas.currentTime) player.resume();
                else player.play();
                art.emit("video:play", {
                    type: "play"
                });
...
if (typeof window !== "undefined") window["artplayerProxyFlv"] = artplayerProxyFlv;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"5dUr6","./WXInlinePlayer":"7GbYU"}],"5dUr6":[function(require,module,exports) {
...
},{}],"7GbYU":[function(require,module,exports) {
parcelRequire = function(e, r, t, n) {
            ...
            var n = function() {
                ...
                return i(e, [
                    ...
                    },
                    {
                        key: "remove",
                        value: function(t) {
                            for(var e = this.callbacks.length - 1; e >= 0; e--)this.callbacks[e] == t && this.callbacks.splice(e, 1);
                        }
                    },
                    {
                        key: "destroy",
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            var e = this.extra, i = t - this.timestamp + e, n = Math.floor(i / this.interval);
                            if ((e = i - this.interval * n) >= this.interval / 1.5 && (n = Math.ceil(i / this.interval), e = 0), n) {
                                for(var s = 0; s < this.callbacks.length; s++)for(var r = 0; r < n; r++)this.callbacks[s](t - this.timestamp);
    ...
    "Bm0n": [
        function(require, module1, exports) {
            "function" == typeof Object.create ? module1.exports = function(t, e) {
    ...
    "ACyo": [
        function(require, module1, exports) {
            ...
            var e = r(require("eventemitter3")), t = r(require("inherits"));
            function r(e) {
            ...
            var s = {
                ...
                workerify: function(r) {
                    var s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], i = this.getFuncBody(r.toString());
                    function o(t) {
                        var r = this;
                        ...
                        this.url = URL.createObjectURL(s), this.worker = new Worker(this.url), this.worker.onmessage = function(e) {
                            var t = e.data, s = t.id, i = t.data, o = t.destroy, n = t.type;
                            if (o) r.resolves = [], URL.revokeObjectURL(r.url), r.worker.terminate(), r.worker = null;
                            else if ("event" == n) r.emit(i.type, i.data);
                            else for(var a = r.resolves.length - 1; a >= 0; a--)if (s == r.resolves[a].id) {
                    ...
                    }, a = 0; a < s.length; a++)n(a);
                    return o;
                },
                getFuncBody: function(e) {
    ...
    "f7mc": [
        function(require, module1, exports) {
            ...
            var t = require("buffer"), e = o(require("eventemitter3"));
            function o(t) {
            ...
            var m = window.webkitAudioContext || window.AudioContext, y = function(o) {
                s(r, e.default);
                var n = c(r);
                function r(e) {
                    var o, u = e.volume, s = e.muted;
                ...
                return u(r, [
                    {
                        ...
                        value: function() {
                            ...
                            for(var e = 0; e < this.audioSrcNodes.length; e++)if (t <= 1e3 * this.audioSrcNodes[e].timestamp) {
                        ...
                        value: function(t) {
                            if ("blocked" == this.state) {
                                ...
                                for(var e = 0; e < this.audioSrcNodes.length; e++){
                                    var o = this.audioSrcNodes[e], n = o.source, i = o.timestamp, r = o.duration;
                                    ...
                                    if (u.onended = this._onAudioBufferEnded.bind(this), !this.playStartedAt) {
                                        var s = this.context, a = s.currentTime, c = s.baseLatency, d = s.sampleRate, l = r + (c || 128 / d);
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var o = this;
                            return e.length && (e = t.Buffer.from(e), this.data = t.Buffer.concat([
                                this.data,
                                e
                            ]), this.context) ? new Promise(function(t) {
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            if (o.onended = this._onAudioBufferEnded.bind(this), !this.playStartedAt) {
                                var n = e.duration, i = this.context, r = i.currentTime, u = i.baseLatency, s = i.sampleRate, a = n + (u || 128 / s);
    ...
    "Howj": [
        function(require, module1, exports) {
            ...
            var e = u(require("../util/util")), t = u(require("./browser")), r = u(require("./wechat"));
            function u(e) {
                return e && e.__esModule ? e : {
                    default: e
                };
    ...
    "ILxu": [
        function(require, module1, exports) {
            ...
            var e = require("buffer"), t = a(require("eventemitter3")), i = a(require("../util/ticker")), s = a(require("../sound/sound")), r = a(require("../util/util"));
            function a(e) {
                return e && e.__esModule ? e : {
                    default: e
                };
            ...
            var b = function(a) {
                ...
                var n = c(h);
                function h(e) {
                    var t, a = e.volume, u = void 0 === a ? 1 : a, f = e.muted, d = void 0 !== f && f, c = e.preloadTime, m = void 0 === c ? 1e3 : c, g = e.bufferingTime, p = void 0 === g ? 3e3 : g, b = e.cacheSegmentCount, v = void 0 === b ? 128 : b;
                    return o(this, h), (t = n.call(this)).averageUnitDuration = 0, t.averageDecodeCost = 0, t.soundHeadSliced = !1, t.framerate = 1e3 / 24, t.isEnded = !1, t.state = "created", t.baseTime = 0, t.blocked = !r.default.isWeChat(), t.hasVideo = !0, t.hasAudio = !0, t.frames = [], t.audios = [], t.currentTime = 0, t.bufferingIndex = -1, t.minBufferingTime = m, t.bufferingTime = p, t.cacheSegmentCount = v, t.ticker = new i.default, t.sound = new s.default({
                        volume: u,
                        muted: d
                ...
                return u(h, [
                    ...
                    },
                    {
                        key: "getCurrentTime",
                        value: function() {
                            return this.hasAudio ? this.sound ? 1e3 * this.sound.getCurrentTime() : 0 : this.hasVideo ? this.currentTime : 0;
                        }
                    },
                    {
                        key: "process",
                            ...
                            if ("created" != this.state) {
                                if (this.hasAudio && this.hasVideo) {
                                    ...
                                    if (this.currentTime = this.getCurrentTime(), this.frames.length) {
                                        ...
                                        if (-1 == this.bufferingIndex) this.bufferingIndex = t, e = i - this.currentTime;
                                        else if (this.frames[this.bufferingIndex]) e = i - this.frames[this.bufferingIndex].timestamp;
                                    }
                                    if (!this.frames.length || !this.isEnded && e && e < this.minBufferingTime) return "buffering" != this.state && this.emit("buffering"), this.sound.pause(), void (this.state = "buffering");
                                    ...
                                    for(var s = 0; s < this.frames.length; s++){
                                        var r = this.frames[s].timestamp, a = this.currentTime - r;
                                        if (Math.abs(a) <= 25) {
                                    ...
                                    var n = 1e3 * this.sound.getAvaiableDuration(), o = this.bufferingTime;
                                    ...
                                    if (!this.isEnded && "buffering" == this.state) return;
                                    !this.isEnded && this.frames.length < this.cacheSegmentCount / 3 && this.ticker.setFps(this.framerate / 1.5);
                                ...
                                if (this.hasVideo && this.frames.length) {
                                    var f = this.frames.length - 1, d = this.currentTime;
                                    u = this.frames[f].timestamp - d;
                                }
                                if (!this.isEnded && "buffering" != this.state && this.hasVideo && !this.hasAudio && u < this.bufferingTime) return this.state = "buffering", void this.emit("buffering");
                        ...
                        value: function(t) {
                            if ("destroy" != this.state) switch(t.type){
                                case "ready":
                                    ...
                                    break;
                                case "header":
                                    var i = t.data, s = i.hasVideo, r = i.hasAudio;
                                ...
                                case "mediaInfo":
                                    ...
                                    break;
                                case "video":
                                    var h = t.data, u = h.timestamp, f = h.width, d = h.height, c = h.stride0, m = h.stride1, l = h.buffer;
                                    ...
                                    break;
                                case "audio":
                                    var g = t.data, p = g.timestamp, b = g.buffer;
                                    this.baseTime || (this.baseTime = p), this.audios.push(e.Buffer.from(new Uint8Array(b)));
                                    break;
                                case "decode":
                                    ...
                                    var v = t.data, y = v.consume, k = v.duration;
                                    ...
                                    break;
                                case "complete":
                                    this.isEnded = !0, this.state = "end", this.emit("end");
                            }
                        }
                    }
                ]), h;
    ...
    "Monm": [
        function(require, module1, exports) {
            ...
            function t() {
                var t = !1;
                try {
                    t = (new SharedArrayBuffer(0), true);
                } catch (r) {}
                function e(e, a, n) {
                    if ((!n || n - a > e.length) && (n = e.length), t) {
                        var r = new SharedArrayBuffer(n - a), s = new Uint8Array(r);
                        return s.set(e.subarray(a, n)), s;
                    }
                    return e.subarray(a, n);
                }
                function a(t) {
                    var e = t.url, a = t.chunkSize, n = void 0 === a ? 262144 : a;
                ...
                a.prototype.hasData = function() {
                    ...
                    return this.reader ? this.reader.read().then(function(e) {
                        var a, n, r, s = e.value, i = e.done;
                        if (s = new Uint8Array(s || 0), t.data = (a = t.data, n = s, (r = new Uint8Array(a.length + n.length)).set(new Uint8Array(a), 0), r.set(new Uint8Array(n), a.length), r), i) t.done = !0;
                        else if (t.data.length < t.chunkSize) return t._request();
                    }) : fetch(this.url, {
                        method: "GET"
                    }).then(function(e) {
                        var a = e.status, n = e.statusText;
                ...
                self.onmessage = function(t) {
                    var e = t.data, r = e.type, s = e.id, i = e.data;
    ...
    "DaV8": [
        function(require, module1, exports) {
            ...
            var t = require("buffer"), e = r(require("eventemitter3"));
            function r(t) {
                return t && t.__esModule ? t : {
                    default: t
                };
            ...
            var d = 3, p = !1;
            try {
                p = (new SharedArrayBuffer(0), true);
            } catch (v) {}
            var x = function(r) {
                a(u, e.default);
                var n = f(u);
                function u(t) {
                    var e, r = t.url, i = t.chunkSize, a = void 0 === i ? 262144 : i;
                ...
                return i(u, [
                    ...
                    },
                    {
                        key: "_request",
                        value: function() {
                            for(var t = this, e = !1, r = this._fetch(), n = function(n) {
                                r = r.then(function(r) {
                                    if (e || (e = !0, t.downloadSize += r.length, r.length < t.chunkSize && (t.done = !0)), p) {
                                        var n = new SharedArrayBuffer(r.byteLength), o = new Uint8Array(n);
                                        o.set(r), r = o;
                                    }
                                    return r;
                                }).catch(function(e) {
                                    if (n >= d - 1) throw t.emitted || (t.emitted = !0, t.emit("loadError", e)), e;
                                    return t._fetch();
                                });
                            }, o = 0; o < d; o++)n(o);
                            return r;
    ...
    "TytF": [
        function(require, module1, exports) {
            ...
            var e = u(require("./stream")), r = u(require("./chunk")), t = u(require("../util/util"));
            function u(e) {
                return e && e.__esModule ? e : {
                    default: e
                };
            ...
            function a(u) {
                var a = u.type, n = void 0 === a ? "chunk" : a, d = u.opt;
                return "chunk" == n ? new r.default(d) : new (t.default.workerify(e.default, [
                    "read",
                    "cancel",
                    "hasData"
                ]))(d);
                ...
                return r(t, [
                    {
                        ...
                        value: function(e, t, r) {
                            var a = this.yTextureRef, n = this.uTextureRef, i = this.vTextureRef, o = this.contextGL;
                            o.pixelStorei(o.UNPACK_ALIGNMENT, 1), o.viewport(0, 0, e, t);
                            var u = r, l = e * t, s = u.subarray(0, l);
                            ...
                            var T = e * t / 4, f = u.subarray(l, l + T);
                            ...
                            var x = T, c = u.subarray(l + T, l + T + x);
                    ...
                    },
                    {
                        key: "_initContextGL",
                        value: function() {
                            for(var e = this.$canvas, t = [
                                "webgl",
                                "experimental-webgl",
                                "moz-webgl",
                                "webkit-3d"
                            ], r = null, a = 0; !r && a < t.length;){
                                var n = t[a];
                                try {
                                    r = e.getContext(n);
                                } catch (i) {
                    ...
                    },
                    {
                        key: "_initProgram",
                        value: function() {
                            var e = this.contextGL, t = e.createShader(e.VERTEX_SHADER);
                    ...
                    },
                    {
                        key: "_initBuffers",
                        value: function() {
                            var e = this.contextGL, t = this.shaderProgram, r = e.createBuffer();
                    ...
                    },
                    {
                        key: "_initTextures",
                        value: function() {
                            var e = this.contextGL, t = this.shaderProgram, r = this._initTexture(), a = e.getUniformLocation(t, "ySampler");
                            e.uniform1i(a, 0), this.yTextureRef = r;
                            var n = this._initTexture(), i = e.getUniformLocation(t, "uSampler");
                            e.uniform1i(i, 1), this.uTextureRef = n;
                            var o = this._initTexture(), u = e.getUniformLocation(t, "vSampler");
                    ...
                    },
                    {
                        key: "_initTexture",
                        value: function() {
                            var e = this.contextGL, t = e.createTexture();
                ...
                ], [
                    {
                        key: "isSupport",
                        value: function() {
                            for(var e = document.createElement("canvas"), t = [
                                "webgl",
                                "experimental-webgl",
                                "moz-webgl",
                                "webkit-3d"
    ...
    "Focm": [
        function(require, module1, exports) {
            ...
            var e = n(require("eventemitter3")), t = n(require("./processor/processor")), i = n(require("./loader/loader")), r = n(require("./drawer/drawer")), o = n(require("./util/util"));
            function n(e) {
                return e && e.__esModule ? e : {
                    default: e
                };
            ...
            var w = {
                ...
                var s = h(u);
                function u(e) {
                    var t, i = e.url, r = void 0 === i ? "" : i, n = e.$container, l = e.hasVideo, c = void 0 === l || l, d = e.hasAudio, h = void 0 === d || d, p = e.volume, f = void 0 === p ? 1 : p, m = e.muted, y = void 0 !== m && m, v = e.autoplay, b = void 0 !== v && v, g = e.loop, k = void 0 !== g && g, _ = e.isLive, P = void 0 !== _ && _, S = e.chunkSize, T = void 0 === S ? 262144 : S, E = e.preloadTime, I = void 0 === E ? 1e3 : E, L = e.bufferingTime, O = void 0 === L ? 3e3 : L, C = e.cacheSegmentCount, H = void 0 === C ? 128 : C, U = e.customLoader, j = void 0 === U ? null : U;
                    return a(this, u), (t = s.call(this)).url = r, t.$container = n, t.width = n.width, t.height = n.height, t.vol = f, t.muted = y, t.duration = 0, t.autoplay = b, t.loop = k, t.isLive = P, t.chunkSize = T, t.preloadTime = I, t.bufferingTime = O, t.cacheSegmentCount = H, t.customLoader = j, t.timeUpdateTimer = null, t.isInitlize = !1, t.isEnd = !1, t.state = w.created, (c && !h || o.default.isWeChat()) && t.autoplay && (t._initlize(), t.processor.unblock(0)), t;
                }
                return l(u, [
                    {
                        key: "play",
                        value: function() {
                            this.state == w.destroyed || this.isInitlize || (this._initlize(), this.processor.unblock(0)), this.emit("play");
                        }
                    },
                    {
                        key: "stop",
                        value: function() {
                            this.state = w.stopped, this.isInitlize = !1, clearInterval(this.timeUpdateTimer), this.processor && (this.processor.destroy(), this.processor = null), this.loader && (this.loader.removeAllListeners(), this.loader.cancel()), this.emit("stopped");
                        }
                    },
                    {
                        key: "pause",
                    ...
                    },
                    {
                        ...
                        value: function() {
                            ...
                            this.processor && this.processor.resume();
                        }
                    },
                    {
                        key: "volume",
                    ...
                    },
                    {
                        key: "destroy",
                        value: function() {
                            this.removeAllListeners(), this.stop(), this.drawer && (this.drawer.destroy(), this.drawer = null), this.state = w.destroyed;
                        }
                    },
                    {
                        key: "getCurrentTime",
                        value: function() {
                            return this.processor ? this.processor.getCurrentTime() : 0;
                        }
                    },
                    {
                        key: "getAvaiableDuration",
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var e = this;
                            clearInterval(this.timeUpdateTimer), this.timeUpdateTimer = setInterval(function() {
                                var t = 0;
                                e.isEnd ? (e.emit("timeUpdate", e.duration), (e.processor.hasAudio && t >= e.duration || e.processor.hasVideo && !e.processor.frames.length) && e.loop && (e.stop(), e.play())) : (e.processor && (t = e.processor.getCurrentTime()), e.emit("timeUpdate", t < 0 ? 0 : t));
                            }, 250), this.isEnd = !1, this.drawer = new r.default(this.$container), this.loader = new (this.customLoader ? this.customLoader : i.default)({
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            for(var t = e.onMetaData, i = void 0 === t ? [] : t, r = 0; r < i.length; r++)"duration" in i[r] ? this.duration = 1e3 * i[r].duration : "width" in i[r] ? this.width = i[r].width : "height" in i[r] && (this.height = i[r].height);
                    ...
                    },
                    {
                        key: "_onFrameHandler",
                        value: function(e) {
                            var t = e.width, i = e.height, r = e.data;
                            this.drawer && this.drawer.drawNextOutputPicture(t, i, r);
                        }
                    },
                    {
                ...
                ], [
                    {
                        key: "isSupport",
                        value: function() {
                            return !!(!/UCBrowser|Quark/.test(window.navigator.userAgent) && window.fetch && window.ReadableStream && window.Promise && window.URL && window.URL.createObjectURL && window.Blob && window.Worker && (new Audio).canPlayType("audio/aac;").replace(/^no$/, "") && (window.AudioContext || window.webkitAudioContext) && r.default.isSupport());
                        }
                    },
                    {
                        key: "init",
                        value: function(e) {
                            var t = e.asmUrl, i = e.wasmUrl;
                            u.initPromise = new Promise(function(e, r) {
                                var o = window.WebAssembly ? i : t, n = document.head || document.getElementsByTagName("head")[0], s = document.createElement("script");
                                s.onload = function() {
                                    u.isInited = !0, e();
                                }, s.onerror = function(e) {
                                    return r(e);
                                }, s.src = "".concat(o), s.type = "text/javascript", n.appendChild(s);
                            });
                        }
                    },
                    {
                        key: "ready",
                        value: function() {
                            return u.isSupport() ? u.isInited ? Promise.resolve(!0) : u.initPromise : Promise.resolve(!1);
                        }
                    }
                ]), u;
            }();
            v(b, "isInited", !1), window.WXInlinePlayer = b;
            var g = b;
            exports.default = g;
        },
        {
