/*!
 * artplayer-proxy-mediabunny.js v1.1.0
      ...
      while (context.currentPos - startPos < remaining) {
        ...
        if (codec === "aac") {
          ...
          if (header) {
            ...
            return context.supplyPacket(remaining3, Math.round(SAMPLES_PER_AAC_FRAME * TIMESCALE / elementaryStream.info.sampleRate));
          } else {
