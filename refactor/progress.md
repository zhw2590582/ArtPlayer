...
2026-09-10 新增 DOC-06：用户授权自主安装需要的新依赖、添加或改进合理脚本。已写入根指令、质量要求、工具链规范、AI 流程和 ADR-015；没有在这次记录任务中安装依赖或修改生产脚本。任务总数现为 192，6 个规划任务与 186 个待执行任务以 tasks.json 为准。DOC-05 已提交为 `570600d2`；DOC-06 的本地提交通过 Git 主题中的 `[DOC-06]` 追溯。
