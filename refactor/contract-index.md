...
- PUB-artplayer-plugin-multiple-subtitles-1.2.0: artplayer-plugin-multiple-subtitles@1.2.0 (published-baseline)；[来源](../refactor/baselines/multiple-subtitles-release.json) JSON pointer `/release`。
- PUB-artplayer-plugin-multiple-subtitles-1.1.0: artplayer-plugin-multiple-subtitles@1.1.0 (published-baseline)；[来源](../refactor/baselines/multiple-subtitles-release.json) JSON pointer `/previous/0`。
- PUB-artplayer-plugin-multiple-subtitles-1.0.0: artplayer-plugin-multiple-subtitles@1.0.0 (published-baseline)；[来源](../refactor/baselines/multiple-subtitles-release.json) JSON pointer `/previous/1`。
