...
**2026-09-16 阶段交接：用户要求尽快停止当前长任务，转入用户主导的长期自测。**
当前以[自测交接与延期清单](self-test-handoff.md)为执行入口；未完成项明确延期，
不再自动追加修复、长测、完整矩阵或发布准备。以下完整计划保留为后续待办，
不代表必须在本轮结束前全部完成，也不代表当前已经通过发布验收。
逐项处理时查看[遗留问题完整清单](remaining-issues.md)：包含全部开放风险、
独立修复分支、已按范围接受的差异，以及所有延期任务的索引。
...
| [核心声明语义映射](core-content-review.json) | 逐组记录已核对声明、源码与指南哈希；未覆盖记录不自动算完成 |
