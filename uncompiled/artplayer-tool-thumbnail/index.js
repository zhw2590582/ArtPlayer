var ArtplayerToolThumbnail = (function() {
  "use strict";
  class Emitter {
    on(name, fn, ctx) {
  ...
  class ArtplayerToolThumbnail2 extends Emitter {
    constructor(option = {}) {
      super();
      this.processing = false;
      this.option = {};
      this.setup(Object.assign({}, ArtplayerToolThumbnail2.DEFAULTS, option));
      this.video = ArtplayerToolThumbnail2.creatVideo();
      this.duration = 0;
      this.inputChange = this.inputChange.bind(this);
      this.ondrop = this.ondrop.bind(this);
      this.option.fileInput.addEventListener("change", this.inputChange);
      this.option.fileInput.addEventListener("dragover", ArtplayerToolThumbnail2.ondragover);
      this.option.fileInput.addEventListener("drop", ArtplayerToolThumbnail2.ondrop);
    }
    static get DEFAULTS() {
      return {
        number: 60,
    ...
    destroy() {
      ...
      this.option.fileInput.removeEventListener("dragover", ArtplayerToolThumbnail2.ondragover);
      this.option.fileInput.removeEventListener("drop", ArtplayerToolThumbnail2.ondrop);
  ...
  return ArtplayerToolThumbnail2;
})();
