...
Monaco/vConsole components, the 42 identified console components or their notice
...
headers, embedded dependency licenses and upstream author notices now ship as 42 files
