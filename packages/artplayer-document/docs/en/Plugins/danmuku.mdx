...
var art = new Artplayer({
    ...
    plugins: [
        artplayerPluginDanmuku({
            ...
            minWidth: 200, // At the at least width of the input box
            maxWidth: 400, // Maximum width in the input box
            theme: 'dark', // The theme color of the input box
            beforeEmit: (danmu) => !!danmu.text.trim(), // Custom verification before the barrage emit
            mount: undefined, // Customized input box mount position
        }),
    ],
});
```
