      ...
      '/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '自动缩略图', link: '/plugin/auto-thumbnail' },
            { text: '多重字幕', link: '/plugin/multiple-subtitles' },
            { text: 'ASS 字幕 - JASSUB', link: '/plugin/jassub' },
            { text: 'Chromecast', link: '/plugin/chromecast' },
            { text: 'VAST 广告', link: '/plugin/vast' },
            { text: '视频章节', link: '/plugin/chapter' },
            { text: '视频背光', link: '/plugin/ambilight' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'dash.js', link: 'https://artplayer.org/?libs=https://cdnjs.cloudflare.com/ajax/libs/dashjs/5.2.1/modern/umd/dash.all.min.js&example=dash' },
      ...
      '/en/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Automatic Thumbnails', link: '/en/plugin/auto-thumbnail' },
            { text: 'Multiple Subtitles', link: '/en/plugin/multiple-subtitles' },
            { text: 'ASS Subtitle - JASSUB', link: '/en/plugin/jassub' },
            { text: 'Chromecast', link: '/en/plugin/chromecast' },
            { text: 'VAST', link: '/en/plugin/vast' },
            { text: 'Video Chapters', link: '/en/plugin/chapter' },
            { text: 'Video Ambilight', link: '/en/plugin/ambilight' },
