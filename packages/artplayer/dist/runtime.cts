...
// eslint-disable-next-line ts/no-redeclare, ts/no-namespace -- Named types share the existing CommonJS export.
...
// eslint-disable-next-line no-restricted-syntax -- Preserve the actual CommonJS constructor export.
export = Artplayer
