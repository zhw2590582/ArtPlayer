import type { PlacementRequest, PlacementRow, VisibleDanmu } from './worker-types'

export function getDanmuTop({ target, visibles, clientWidth, clientHeight, marginBottom, marginTop, antiOverlap }: PlacementRequest): number | undefined {
  // 弹幕最大高度
